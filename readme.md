...
本分支提供 Minecraft **1.21.1** 的 Fabric 和 NeoForge 客户端模组，运行需要 Java 21。Paper、Velocity、BungeeCord 插件由 [plugin 分支](https://github.com/MOPELotus/MusicHud-TuneWeave/tree/plugin)构建。
...
构建使用 JDK 25；1.21.1 分支的测试还需要 JDK 21。
