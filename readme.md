...
本分支提供 Minecraft **26.1、26.1.1、26.1.2** 的 Fabric 和 NeoForge 客户端模组，运行需要 Java 25。Paper、Velocity、BungeeCord 插件由 [plugin 分支](https://github.com/MOPELotus/MusicHud-TuneWeave/tree/plugin)构建。
