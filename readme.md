...
本分支提供 Minecraft **1.21.11** 的 Fabric 和 NeoForge 客户端模组，运行需要 Java 21。Paper、Velocity、BungeeCord 插件由 [plugin 分支](https://github.com/MOPELotus/MusicHud-TuneWeave/tree/plugin)构建。
