...
public final class HudLayoutEditorScreen extends Screen {
    ...
    @Override public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        graphics.text(font, "HUD " + bounds.width() + " × " + bounds.height(), x + 4, Math.max(18, y - 12), 0xffffffff);
        graphics.centeredText(font, label("hint"), width / 2, 8, 0xffffffff);
    ...
    @Override public void onClose() { minecraft.gui.setScreen(previous); }
