...
package indi.mopelotus.musichud.client.audio.decoder.flac.common;

import java.io.IOException;
import java.util.Objects;
import indi.mopelotus.musichud.client.audio.decoder.flac.decode.DataFormatException;
import indi.mopelotus.musichud.client.audio.decoder.flac.decode.FlacLowLevelInput;
import indi.mopelotus.musichud.client.audio.decoder.flac.decode.FrameDecoder;
import indi.mopelotus.musichud.client.audio.decoder.flac.encode.BitOutputStream;
...
public final class FrameInfo {
	...
	private static long readUtf8Integer(FlacLowLevelInput in) throws IOException {
		...
		if (n == 0)
			...
			if ((result >>> 36) != 0)
				throw new AssertionError();
			if (result < (1L << (n == 2 ? 7 : n * 5 - 4)))
				throw new DataFormatException("Overlong UTF-8 coded number");
			return result;
		}
	}
